...
const AuthPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //added this so that there are no issue with the route itself cause of special characters

    const encodedEmail = encodeURIComponent(email.trim());

    // Navigate with the encoded email
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* section-4 */}
      <div className="py-10 bg-black text-white">
        <div className="flex maz-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          <div className="flex-1 relative">
